...
public class ArmsLength extends AbstractExampleCard {
    /**
     * 获取类名 亲疏自行
     */
    public static final String CLASS_NAME = ArmsLength.class.getSimpleName();
    /**
     * 获取类名作为卡牌id
     */
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        addToBot((AbstractGameAction)new ApplyPowerAction((AbstractCreature)p, (AbstractCreature)p, (AbstractPower)new ArtifactPower((AbstractCreature)p, 1)));
    }

    @Override
    public AbstractCard makeCopy() {
        //复制卡牌时触发
        return new ArmsLength();
    }

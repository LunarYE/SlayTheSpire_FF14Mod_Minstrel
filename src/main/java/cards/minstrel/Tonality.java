...
public class Tonality extends AbstractExampleCard {
    /**
     * 获取类名 宁神小调
     */
    public static final String CLASS_NAME = Tonality.class.getSimpleName();
    /**
     * 获取类名作为卡牌id
     */
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        addToBot((AbstractGameAction) new ApplyPowerAction((AbstractCreature) AbstractDungeon.player, (AbstractCreature) AbstractDungeon.player, (AbstractPower) new BarricadePower((AbstractCreature) AbstractDungeon.player)));
